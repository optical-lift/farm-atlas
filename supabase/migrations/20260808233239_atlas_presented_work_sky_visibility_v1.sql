  ...
  select
    ...
    case
      ...
      when task.status='open' and task.due_date<v_work_date and row.presentation_state='held' and row.presentation_reason in ('held_beyond_regular_minutes','held_beyond_recovery_minutes') then true
        ...
        task.status='open' and task.due_date=v_work_date and row.presentation_state='held' and row.presentation_reason in ('held_beyond_regular_minutes','held_beyond_recovery_minutes')
      )
    end as overload,
