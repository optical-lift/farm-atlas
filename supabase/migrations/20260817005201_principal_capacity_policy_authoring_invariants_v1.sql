...
'Authenticated Principal authoring contract for explicit capacity policy. Validates weekday, local-time, minute, and effective-date invariants; never seeds or infers a schedule.';
