-- Simplify Elm Venue resources to the things that are actually rentable.
-- Production migration: elm_venue_coffee_bar_resource_simplification_v3
-- Coffee Bar becomes the canonical rentable resource. Kitchen, Dining Room, and Water leave the universal kernel.
