drop function if exists atlas.worker_record_task_transition_v1(uuid,text,text,text,text,jsonb);

create function atlas.worker_record_task_transition_v1(
  p_task_id uuid,
  p_transition text,
...
revoke execute on function atlas.worker_record_task_transition_v1(uuid,text,text,text,text,jsonb,date,text,text,uuid) from public, anon;
grant execute on function atlas.worker_record_task_transition_v1(uuid,text,text,text,text,jsonb,date,text,text,uuid) to authenticated, service_role;
