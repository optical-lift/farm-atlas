-- P9: Harvest requirement expression and nonblocking commercial-target truth.
...
values
('crop-harvest-response-required','crop_cycle','{}'::jsonb,jsonb_build_object('harvestResponseRequired',true),'operation_requirement','harvest','farm_operations',30,
...
'P9 crop Requirement Expression: transplant and harvest are independent source requirements. Harvestability is sufficient before buyer allocation; commercial target is a separate nonblocking truth gap.';
