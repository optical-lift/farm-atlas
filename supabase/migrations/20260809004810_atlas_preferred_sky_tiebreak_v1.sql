...
begin
  ...
  with candidate_tasks as materialized (
    ...
    cross join lateral (
      select case
        when t.status='open'
         and t.commitment_kind='floating'
         and t.due_date is null
         and t.operation_class is not null
...
'Body Budget presentation planner. Preferred sky fitness is a tie-break only after obligation/due/priority truth; it never overrides hard windows, process continuity, urgency, or capacity and never withholds work.';
