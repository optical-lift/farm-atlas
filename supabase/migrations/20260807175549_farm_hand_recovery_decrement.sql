...
insert into atlas.authenticated_rpc_registry(
  ...
  jsonb_build_object(
    'source','farm_hand_recovery_decrement',
    'call_site','canonical farm-hand completion transition',
    'authorization','signed-in worker may consume recovery only through their own assigned task',
