...
begin
  ...
  with candidate_base as (
    ...
    select
      ...
      ) order by d.required_this_week desc,d.hard_finish_date nulls last,d.latest_lawful_date nulls last,d.due_date nulls last,d.title,d.task_id),'[]'::jsonb) as work,
