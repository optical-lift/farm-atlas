...
'Principal root context. Raw clockCandidates are compatibility inventory; principalClock is authoritative arbitration; principalOffice carries theses, attention, functions, scoreboards, and House Position.';