      ...
      <section className={styles.detail}>
        ...
        <div className={styles.paths}>
          <div className={styles.path}>
            ...
            <Link className={styles.primary} href="/start/personal">Start with me</Link>
          </div>
          ...
          <div className={styles.path}>
            ...
            <Link className={styles.secondary} href="/start/organization">Start with an organization</Link>
          </div>
        </div>
