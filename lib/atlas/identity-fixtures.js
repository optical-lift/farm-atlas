function realityIdentity(key, displayName) {
  const personId = `fixture-person-${key}`;
  return {
    state: "ready",
    ...
    personalAtlas: Object.freeze({
      id: `fixture-personal-atlas-${key}`,
      personEntityId: personId,
      state: "active",
      native: true,
    }),
    ledgerSeats: Object.freeze([]),
    compatibilityOrganizationIds: Object.freeze([]),
  };
}
...
export const ATLAS_IDENTITY_FIXTURES = Object.freeze({
  owner: Object.freeze({
    ...
    ...realityIdentity("owner", "Owner Fixture"),
  ...
  manager: Object.freeze({
    ...
    ...realityIdentity("manager", "Manager Fixture"),
    profile: Object.freeze({
  ...
  farmHand: Object.freeze({
    ...
    ...realityIdentity("farm-hand", "Farm-Hand Fixture"),
    profile: Object.freeze({
