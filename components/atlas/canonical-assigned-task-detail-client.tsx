...
export type CanonicalAssignedTaskDetailClientProps = {
  task: AtlasTaskCard;
...
export default function CanonicalAssignedTaskDetailClient(props: CanonicalAssignedTaskDetailClientProps) {
