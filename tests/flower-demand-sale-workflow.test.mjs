...
test("Harvest exposes demand before movement and gates Sale commitment on explicit truth", () => {
  ...
  assert.match(workspace, /Commit to Sale/);
  assert.match(workspace, /Demand alone never does/);
  assert.match(workspace, /Fulfillment and payment remain separate downstream truth/);
});
