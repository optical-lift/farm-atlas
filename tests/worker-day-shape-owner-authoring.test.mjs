...
const migration = readFileSync(join(root, "supabase/migrations/20260816050546_worker_day_shape_owner_authoring_v1.sql"), "utf8");
const route = readFileSync(join(root, "app/api/atlas/owner-worker-day-shape/route.ts"), "utf8");
const control = readFileSync(join(root, "components/atlas/clock/clock-day-shape-control.tsx"), "utf8");
