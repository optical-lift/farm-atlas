...
test("germination cards record biological observations in the selected worker context", () => {
  ...
  assert.match(route, /owner_operator_record_germination_observation_v3/);
  assert.match(route, /record_germination_observation_for_member_v3/);
  ...
  assert.match(focus, /Failed: "Bed open · choose next crop"/);
